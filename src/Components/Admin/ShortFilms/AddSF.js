...
import { Form, Input, Button, DatePicker, Select, Upload, Col, Row ,Rate} from 'antd';
...
const AddSFForm = ({ onSubmit }) => {
  ...
  const formFields = [
    {
      label: <span className="philosopher-font">ShortFilm Title</span>,
      name: "shortfilmTitle",
      rules: [
        {
          required: true,
          message: (
            <span className="philosopher-font">
              Please enter the shortfilm name
            </span>
          ),
        },
      ],
  ...
  return (
    <div>
    <Container>
      <h4  className="mt-3 mb-3">Add ShortFilms</h4>
      <hr />
