  ...
  function TvShows() {
    return (
      <div>
        <div className="about">
          <Container>
            <h1 style={{ paddingTop: "3%" }}>TV Shows</h1>
            <div>
              <Row>
                <Col>
                  <a
                  ...
                  <Row>
                    {Fiction.map((series) => (
                      <Col
                        ...
                        lg={2}
                      >
                        <a href={series.link} alt="" style={{textDecoration:"none"}}><Card className="tv-show-card" style={{ width: "100%", marginBottom: "15px" }}>
                          <Card.Img
                            variant="top"
                            src={series.imageUrl}
